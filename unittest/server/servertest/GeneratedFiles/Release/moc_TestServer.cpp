...
const QMetaObject TestServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestServer.data,
      qt_meta_data_TestServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TestServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TestServer.stringdata0))
        return static_cast<void*>(const_cast< TestServer*>(this));
